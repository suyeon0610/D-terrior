...
public class StoreController {
	...
	public void cart(Model model, HttpSession session) {
		...
		int userNum = ((UserVO)session.getAttribute("user")).getUserNum();
		model.addAttribute("products", service.getCartList(userNum));
	}
	...
	public String cartIn(@RequestBody StoreVO vo) {
		System.out.println("/store/cartIn: POST");
